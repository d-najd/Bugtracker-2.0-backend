...
class TableIssueServiceImpl(
	...
	override fun issuesBelongToSameTable(
		fId: Long,
		sId: Long,
	): Boolean {
	...
	override fun swapIssuePositions(
		fId: Long,
		sId: Long,
	): TableIssueDtoList {
