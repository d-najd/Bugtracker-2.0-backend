...
class ProjectController(
	...
	): ProjectDtoList = service.getAllByUsername(userDetails.username)

	@GetMapping("/{id}")
	@ScopedAuthorize("#id", ScopedEvaluatorType.Project, ScopedPermission.View)
	fun get(
		@PathVariable id: Long,
	): ProjectDto = service.get(id)
	...
	): ProjectDto = service.create(userDetails.username, projectDto)

	@PutMapping("/{id}")
	@ResponseStatus(value = HttpStatus.OK)
	@ScopedAuthorize("#id", ScopedEvaluatorType.Project, ScopedPermission.Owner)
	fun update(
		@PathVariable id: Long,
		@RequestBody projectDto: ProjectDto,
	): ProjectDto = service.update(id, projectDto)
