...
ALTER TABLE project_issue_label_type DROP FOREIGN KEY project_issue_label_ibfk_1;

ALTER TABLE project_issue_label_type DROP FOREIGN KEY project_issue_label_ibfk_2;
